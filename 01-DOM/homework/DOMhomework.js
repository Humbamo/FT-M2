...
createdBy.innerHTML = createdBy.innerHTML + " Humberto Barragan PT11B";
...
function displayToDos() {
  // Tu código acá:
  // Seleccionar el elemento cuyo id es 'toDoContainer'
  var toDoContainer = document.getElementById("toDoContainer");

  // Setear el innerHTML de 'toDoContainer' como un string vacio
  toDoContainer.innerHTML = "";

  // Llamar a la función 'buildToDos'
  var toDoElements = buildToDos(toDoItems);

  // Iterar sobre el resultado devuelto por 'buildToDos' e ir agregndo cada elemento a 'toDoContainer'
